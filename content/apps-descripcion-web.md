...
- **Seis oráculos, una sola app.** Cada uno con su propia estética, su propia tirada y su propia voz.
- **Tiradas vivas.** Animaciones cuidadas: monedas que giran, caracoles que caen, cartas que se revelan una a una.
- **Lecturas con alma.** Interpretaciones escritas con dedicación, tratando cada símbolo con respeto.
- **Una biblioteca para aprender.** Descubrí el significado de cada carta, runa, hexagrama y odu a tu ritmo.
- **En tu idioma.** Disponible en varios idiomas.
- **Diseño oscuro y elegante**, hecho para disfrutarse de noche y sin cansar la vista.

> Preguntá. Mirá. Descubrí.
...
> Marcá el punto. La app hace la estadística.

---

*Imago — apps con oficio.*
