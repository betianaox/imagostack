...
export const pt: Dictionary = {
  ...
  panel: {
    ...
    signInText: "Entre com uma conta autorizada.",
    signInButton: "Entrar com o Google",
    signingIn: "Entrando…",
    signOut: "Sair",
    noAccessTitle: "Sem permissões",
    noAccessText:
      "Sua conta não tem acesso ao painel. Se você acha que é um erro, avise um administrador.",
    loading: "Carregando…",
    empty: "Ainda não há conversas.",
    emptyHint: "Elas vão aparecer aqui assim que alguém escrever no chat.",
    selectOne: "Escolha uma conversa da lista.",
    search: "Buscar nas conversas…",
    noMatches: "Nenhuma conversa corresponde à busca.",
    menu: "Seções",
    close: "Fechar",
    modeBot: "O bot está respondendo",
    modeMine: "Você está atendendo",
    modeOther: "Outra pessoa está atendendo",
    take: "Assumir a conversa",
    release: "Devolver ao bot",
    inactive: "Inativa",
    inactiveHint:
      "O visitante fechou o chat: se você responder agora, ele não vai ver. Escreva por e-mail se ele deixou um.",
    placeholder: "Escreva sua resposta…",
    send: "Enviar",
    takeFirst: "Assuma a conversa para poder responder.",
    visitor: "Visitante",
    bot: "Bot",
    you: "Você",
    expiring: "Sem atividade: volta ao bot em instantes.",
    backToList: "Voltar",
    collapse: "Recolher",
    expand: "Expandir",
    ...
    usersIntro: "Quem entra no painel e com quais permissões.",
    usersEmpty: "Ainda não há usuários cadastrados.",
    roleVisitor: "Visitante",
    roleOperator: "Operador",
    roleAdmin: "Administrador",
    roleLabel: "Papel",
    roleError: "Não foi possível alterar o papel.",
    itsYou: "É você",
    lastSeen: "Cadastrado",
  ...
  meta: {
    ...
    keywords: [
      ...
      "jogo de criaturas com a câmera",
    ],
  },
